...
namespace StudentInfo3B
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            section2750.Assignments = this.dbContext.Assignments.Where(s =>
                s.Section.Id == section2750.Id).ToList();
            this.assignmentsListBox.DisplayMember = "DisplayString";
            this.assignmentsListBox.DataSource = section2750.Assignments;
            Assignment assign = section2750.FindAssignment("2750");
            this.assignmentsListBox.SelectedItem = assign;
        ...
        private void sectionsDropDownList_SelectedValueChanged(object sender, EventArgs e)
        {
                ...
                if (selectedSection != null)
            {
                ...
                selectedSection.Assignments = this.dbContext.Assignments.Where(s =>
               s.Section.Id == selectedSection.Id).ToList();
